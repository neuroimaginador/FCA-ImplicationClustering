...
- `planets_example.R` and `.html` present a simple example on how to perform implication clustering with a small dataset.
- `replication_script.R` and the accompanying `.html` file are the code and results of clustering the implications valid in the MONKS datasets. It replicates the results presented in the paper mentioned above.
